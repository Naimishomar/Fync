...
export default function FocusProductivity() {
    ...
    const renderSetup = () => (
        <View className="flex-1 px-8 pt-10">
            <Text className="text-zinc-900 text-3xl font-black  uppercase tracking-tighter leading-tight">Deep <Text className="text-pink-500">Focus</Text></Text>
            ...
            >
                ...
                >
                    <Text className="text-white font-black  text-xs uppercase tracking-widest">Initiate Lockdown</Text>
                </LinearGradient>
            </TouchableOpacity>
        </View>
    );
    ...
    const renderActive = () => (
        <View className="flex-1 items-center justify-center px-8">
            <View className="absolute top-16 items-center">
                ...
                <Text className="text-zinc-900 font-black  uppercase tracking-widest text-xs">{SESSION_THEMES[sessionType].label} Mode</Text>
            </View>
            ...
            >
                {() => (
                    <View className="items-center">
                        <Text className="text-zinc-900 text-8xl font-black  tracking-tighter">
                            {formatTime(seconds)}
                        </Text>
                        <Animated.Text style={{ opacity: fadeAnim }} className="text-slate-400 text-[10px] font-black uppercase mt-6 text-center px-12 tracking-widest leading-5 ">
                            "{currentQuote}"
                        </Animated.Text>
                    </View>
                )}
            ...
            <View className="mt-20 items-center">
                <Text className="text-slate-300 text-[9px] font-black uppercase tracking-[5px] mb-8 ">System Secured • Do not minimize</Text>
                ...
                {seconds <= 0 ? (
                    ...
                    >
                        <Text className="text-white font-black  uppercase tracking-widest text-xs">Finish Session</Text>
                    </TouchableOpacity>
                ) : (
                    <View className="bg-slate-50 px-6 py-2 rounded-full border border-slate-100">
                        <Text className="text-slate-400 text-[8px] font-black uppercase tracking-widest ">Exit disabled during focus</Text>
                    </View>
                )}
            </View>
        </View>
            ...
            {!isAppLocked && (
                <View className="px-8 py-6 flex-row justify-between items-center">
                    ...
                    <View className="bg-white px-4 py-2 rounded-full border border-slate-100 shadow-sm">
                        <Text className="text-[10px] text-pink-500 font-black uppercase tracking-widest ">Mindful Protocol</Text>
                    </View>
