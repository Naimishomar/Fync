      ...
      <View className="relative">
        ...
        {item.prizepool && (
          <View className="absolute top-6 right-6 px-4 py-3 rounded-2xl bg-zinc-900 shadow-xl shadow-black/30">
            ...
            <Text className="text-white text-sm font-black  uppercase tracking-tighter">{item.prizepool}</Text>
          </View>
        )}
      </View>
      ...
      <View className="p-8">
        <View className="flex-row items-center justify-between mb-6">
          ...
          <View className="bg-white px-4 py-2 rounded-2xl border border-gray-100 shadow-sm shadow-black/[0.02]">
            <Text className="text-zinc-900 text-[10px] font-black uppercase tracking-tighter ">{start} – {end}</Text>
          </View>
        </View>

        <Text className="text-zinc-900 text-3xl font-black  tracking-tighter leading-8 mb-4 uppercase" numberOfLines={2}>
          {item.title}
        </Text>
      ...
      <SafeAreaView className="flex-1">
        ...
        <View className="px-6 pt-10 pb-6">
          ...
          <View className="mb-8">
            ...
            <Text className="text-[52px] font-black text-zinc-900 tracking-[-3px] leading-[54px] uppercase ">
              Hackathon<Text className="text-zinc-300">/</Text><Text className=" text-zinc-900">Hub</Text>
            </Text>
          </View>
        ...
        <View className="px-8 mt-4 mb-2">
          <View className="flex-row items-center bg-zinc-50/50 rounded-[28px] px-6 py-4 border border-gray-100">
            ...
            <TextInput
              ...
              className="flex-1 ml-3 text-zinc-900 text-[14px] font-black  uppercase tracking-widest"
            />
            {search.length > 0 && (
