      ...
      <SafeAreaView className="flex-1">
        ...
        <View className="flex-1 justify-center px-8 pb-24">
          ...
          <View className="bg-white p-10 rounded-[40px] border border-slate-100 items-center shadow-2xl shadow-black/5">
            ...
            <Text className="text-2xl font-black italic text-zinc-900 mb-3 text-center uppercase tracking-tight">Enter Room Node</Text>
            ...
            <TextInput 
              ...
              className="w-full bg-slate-50 border border-slate-100 p-6 rounded-3xl mb-10 text-center text-zinc-900 text-4xl font-black italic tracking-[12px] uppercase"
            ...
            <TouchableOpacity 
              ...
              disabled={loading}
              activeOpacity={0.9}
              className={`w-full py-6 rounded-[32px] shadow-2xl flex-row justify-center items-center ${
            ...
            >
              {loading ? (
                ...
                <>
                  <Text className="text-white text-center font-black italic text-lg mr-3 tracking-[3px] uppercase">Initialize</Text>
