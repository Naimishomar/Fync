            ...
            <SafeAreaView className="flex-1" edges={['top']}>
                ...
                <ScrollView className="flex-1 px-6 pt-2" scrollEnabled={false} showsVerticalScrollIndicator={false}>
                    ...
                    <View className="pb-6 flex-row items-center justify-between">
                        <View>
                            ...
                            <Text className="text-slate-400 text-[10px] font-black uppercase tracking-[1px] mt-1">Global Leaderboard</Text>
                        </View>
                        <View className="bg-orange-50 px-3 py-1.5 rounded-xl border border-orange-100">
                            ...
                            <Text className="text-orange-400 text-[8px] font-bold uppercase tracking-widest mt-0.5">Left</Text>
                        </View>
                    </View>

                    {/* Question Mockup */}
                    <View className="bg-white p-6 rounded-[24px] border border-slate-100 shadow-sm mb-5">
                        <View className="flex-row items-center justify-between mb-4">
                            <View className="bg-zinc-900 px-3 py-1.5 rounded-full">
                                <Text className="text-white font-black text-[10px] uppercase">Problem 1</Text>
                            </View>
                            <Text className="text-orange-500 text-[10px] font-black uppercase">+50 XP</Text>
                        </View>
                        <Text className="text-zinc-900 font-black text-xl mb-3 leading-tight">Graph Traversal Optimization</Text>
                        ...
                        <View className="bg-slate-50 p-4 rounded-[16px] mt-5 border border-slate-100">
                            <Text className="font-mono text-zinc-600 text-[10px] font-bold">Input: N=5, M=6, K=3</Text>
                            <Text className="font-mono text-zinc-600 text-[10px] font-bold mt-2">Output: [1, 3, 5]</Text>
                        </View>
                    </View>

                    {/* IDE Space Mockup */}
                    <View className="bg-[#1e1e1e] p-6 rounded-[24px] mb-5 h-56 shadow-sm border border-zinc-800">
                        <View className="flex-row gap-2 mb-5 border-b border-zinc-800 pb-3">
                        ...
                        <Text className="font-mono text-zinc-500 text-xs mt-3 pl-4">// Write your optimized logic here</Text>
                    ...
                    <View className="flex-row gap-3 mb-20">
                        <TouchableOpacity className="flex-1 bg-white p-4 rounded-[20px] border border-slate-200 items-center shadow-sm">
                            <Text className="text-zinc-600 font-black text-xs uppercase tracking-wider">Run Code</Text>
                        </TouchableOpacity>
                        <TouchableOpacity className="flex-1 bg-orange-500 p-4 rounded-[20px] items-center shadow-lg shadow-orange-500/30">
                ...
                <BlurView intensity={80} tint="light" style={{ position: 'absolute', top: 0, bottom: 0, left: 0, right: 0, zIndex: 10 }}>
                    <View className="flex-1 bg-white/80 justify-center items-center">                           
                        ...
                        <View className="items-center px-10 bg-zinc-800 p-8 rounded-2xl mx-5">
                            ...
                            <View className="px-6 py-3">
                                <Text className="text-orange-600 font-black text-[10px] uppercase tracking-[2px]">Systems Booting Up...</Text>
                            </View>
                        </View>
