...
export const FEATURES: Feature[] = [
  ...
  { id: 'academy', art: 'assets/Graduation%20cap/3D/graduation_cap_3d.png', label: 'Fync Academy', hint: 'Structured learning tracks', icon: 'library-outline', route: 'MasterStudyHub', tint: '#8b5cf6', category: 'study', keywords: ['course', 'dsa', 'roadmap'] },
  { id: 'focus', art: 'assets/Hourglass%20done/3D/hourglass_done_3d.png', label: 'Focus Mode', hint: 'Pomodoro timer and streaks', icon: 'timer-outline', route: 'FocusProductivity', tint: '#10b981', category: 'study', keywords: ['pomodoro', 'productivity'] },
  { id: 'bunk', art: 'assets/Bar%20chart/3D/bar_chart_3d.png', label: 'BunkOMeter', hint: 'Attendance calculator', icon: 'flashlight-outline', route: 'BunkOMeter', tint: '#10b981', category: 'study', keywords: ['attendance', 'bunk'] },
  ...
  { id: 'workshops', art: 'assets/Hammer%20and%20wrench/3D/hammer_and_wrench_3d.png', label: 'Workshops', hint: 'Short skill programs', icon: 'easel-outline', route: 'WorkshopList', tint: '#3b82f6', category: 'career' },
  ...
  { id: 'gigs', art: 'assets/Money%20bag/3D/money_bag_3d.png', label: 'Paid Gigs', hint: 'Short paid freelance work', icon: 'cash-outline', route: 'PaidGigs', tint: '#f59e0b', category: 'career', keywords: ['freelance', 'money'] },
  { id: 'profileBuilder', art: 'assets/Identification%20card/3D/identification_card_3d.png', label: 'Profile Builder', hint: 'Raise your Fync score', icon: 'ribbon-outline', route: 'FyncProfileBuilder', tint: '#f59e0b', category: 'career', keywords: ['resume', 'score', 'portfolio', 'github'] },
  ...
  { id: 'battle1v1', art: 'assets/Crossed%20swords/3D/crossed_swords_3d.png', label: '1v1 Battle', hint: 'Live quiz duel', icon: 'flash-outline', route: 'OneVsOneSetup', tint: '#f97316', category: 'events', keywords: ['quiz', 'duel', 'versus'] },
  ...
  { id: 'codingBoard', art: 'assets/Chart%20increasing/3D/chart_increasing_3d.png', label: 'Coding Leaderboard', hint: 'Campus coding ranks', icon: 'podium-outline', route: 'CodingLeaderboard', tint: '#4f46e5', category: 'events', keywords: ['rank', 'leetcode'] },
  { id: 'shadowRival', art: 'assets/Alien%20monster/3D/alien_monster_3d.png', label: 'Shadow Rival', hint: 'Race an anonymous rival', icon: 'eye-off-outline', route: 'ShadowRival', tint: '#4f46e5', category: 'events', keywords: ['rival', 'compete'] },

  // ---------- SOCIAL ----------
  { id: 'alumni', art: 'assets/People%20hugging/3D/people_hugging_3d.png', label: 'Campus Alumni', hint: 'Find seniors from your college', icon: 'school-outline', route: 'FindAlumni', tint: '#0ea5e9', category: 'social' },
  { id: 'alumniConnect', art: 'assets/Telephone%20receiver/3D/telephone_receiver_3d.png', label: 'Alumni Connect', hint: 'Alumni-only chat rooms', icon: 'chatbubbles-outline', route: 'AlumniConnect', tint: '#0ea5e9', category: 'social', access: ['alumni'] },
  { id: 'proHub', art: 'assets/Office%20building/3D/office_building_3d.png', label: 'Professional Hub', hint: 'Global alumni network', icon: 'globe-outline', route: 'ProfessionalHub', tint: '#0ea5e9', category: 'social', access: ['user', 'alumni'] },
  { id: 'teammate', art: 'assets/Busts%20in%20silhouette/3D/busts_in_silhouette_3d.png', label: 'Find Teammate', hint: 'Match for projects and hacks', icon: 'people-outline', route: 'FindTeammate', tint: '#0ea5e9', category: 'social', keywords: ['team', 'partner'] },
  ...
  { id: 'clubs', art: 'assets/Performing%20arts/3D/performing_arts_3d.png', label: 'College Clubs', hint: 'Official campus clubs', icon: 'people-circle-outline', route: 'ClubList', tint: '#14b8a6', category: 'social' },
  ...
  { id: 'fyncMedia', art: 'assets/Clapper%20board/3D/clapper_board_3d.png', label: 'Fync Media', hint: 'Campus news and features', icon: 'newspaper-outline', route: 'FyncMediaFeed', tint: '#f43f5e', category: 'social', keywords: ['news', 'blog'] },

  // ---------- CAMPUS ----------
  { id: 'collegeChat', art: 'assets/Left%20speech%20bubble/3D/left_speech_bubble_3d.png', label: 'College Chat', hint: '24hr campus-wide room', icon: 'chatbox-ellipses-outline', route: 'CollegeChatScreen', tint: '#f97316', category: 'campus', needsCollege: true },
  ...
  { id: 'olx', art: 'assets/Shopping%20bags/3D/shopping_bags_3d.png', label: 'Campus OLX', hint: 'Buy and sell on campus', icon: 'cart-outline', route: 'OLXMarketplace', tint: '#64748b', category: 'campus', keywords: ['marketplace', 'sell', 'buy'] },
  { id: 'lostFound', art: 'assets/Magnifying%20glass%20tilted%20left/3D/magnifying_glass_tilted_left_3d.png', label: 'Lost & Found', hint: 'Report or claim items', icon: 'search-outline', route: 'LostAndFound', tint: '#64748b', category: 'campus' },
  { id: 'rewards', art: 'assets/Wrapped%20gift/3D/wrapped_gift_3d.png', label: 'Rewards Store', hint: 'Spend your Fync points', icon: 'gift-outline', route: 'RewardsMarketplace', tint: '#f59e0b', category: 'campus', keywords: ['points', 'redeem', 'shop'] },

  // ---------- FUN ----------
  { id: 'partyPool', art: 'assets/Party%20popper/3D/party_popper_3d.png', label: 'Party Pool', hint: 'Mini games with friends', icon: 'game-controller-outline', route: 'PartyPool', tint: '#db2777', category: 'fun', keywords: ['games', 'flappy', 'draw'] },
  { id: 'nightClub', art: 'assets/Crescent%20moon/3D/crescent_moon_3d.png', label: '12 AM Club', hint: 'Anonymous, midnight only', icon: 'moon-outline', route: 'TwelveAMHomeCard', tint: '#6366f1', category: 'fun', keywords: ['night', 'anonymous', 'midnight'] },
  { id: 'confessions', art: 'assets/Shushing%20face/3D/shushing_face_3d.png', label: 'Confessions', hint: 'Post anonymously', icon: 'chatbubble-ellipses-outline', route: 'ConfessionFeed', tint: '#14b8a6', category: 'fun', keywords: ['anonymous', 'secret'] },
  ...
  { id: 'videoCall', art: 'assets/Movie%20camera/3D/movie_camera_3d.png', label: 'Video Rooms', hint: 'Live video calls', icon: 'videocam-outline', route: 'VideoCallLobby', tint: '#db2777', category: 'fun', keywords: ['call', 'face'] },
  { id: 'movies', art: 'assets/Film%20frames/3D/film_frames_3d.png', label: 'Entertainment', hint: 'Movies and trailers', icon: 'film-outline', route: 'EntertainmentHome', tint: '#e11d48', category: 'fun', keywords: ['movie', 'trailer', 'cinema'] },

  { id: 'store', art: 'assets/Shopping%20cart/3D/shopping_cart_3d.png', label: 'Fync Store', hint: 'Student deals, curated', icon: 'pricetags-outline', route: 'AffiliateStore', tint: '#EA580C', category: 'campus', keywords: ['shop', 'deals', 'buy', 'discount', 'affiliate'] },
  ...
  { id: 'storeAdmin', label: 'Store Admin', hint: 'List products, track commission', icon: 'cash-outline', route: 'AffiliateAdminScreen', tint: '#e11d48', category: 'account', access: ['admin'] },
