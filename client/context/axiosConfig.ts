...
// Import the xhr adapter directly for React Native/Expo
// @ts-ignore - no declaration file for internal axios module
...
// Explicitly use the xhr adapter function (not string) to avoid auto-detection issues in Expo
