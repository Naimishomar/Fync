  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8 flex flex-col items-center pb-24">
      <header className="max-w-4xl w-full text-center mb-20 pt-12">
         ...
         <h1 className="text-6xl font-black italic tracking-tighter uppercase text-slate-900 mb-4 leading-none">Bug Finder Protocol</h1>
            ...
            >
               <div className="flex items-center justify-between mb-10">
                  <div className={`px-4 py-2 rounded-2xl text-[9px] font-black uppercase tracking-widest ${
                    bug.difficulty === 'Easy' ? 'bg-emerald-50 text-emerald-600' : 'bg-rose-50 text-rose-600'
                  }`}>
               ...
               <h3 className="text-2xl font-black italic tracking-tighter text-slate-900 uppercase mb-4 line-clamp-1 group-hover:text-rose-600 transition-colors">{bug.title}</h3>
      ...
      <div className="mt-24 max-w-5xl w-full flex items-center justify-around border-t border-slate-200 pt-16">
          <div className="text-center group">
             ...
             <p className="text-4xl font-black text-slate-900 italic tracking-tighter leading-none mb-2">{user?.codingStats?.totalSolved || '0'}</p>
          ...
          <div className="text-center group">
             ...
             <p className="text-4xl font-black text-slate-900 italic tracking-tighter leading-none mb-2">{user?.contestHistory?.length || '0'}</p>
          ...
          <div className="text-center group">
             ...
             <p className="text-4xl font-black text-slate-900 italic tracking-tighter leading-none mb-2">{(user?.codingStats?.totalSolved || 0) * 50}</p>
