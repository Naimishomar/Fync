      ...
      <AnimatePresence mode="wait">
        {status === 'idle' && (
          ...
          >
             ...
             <h1 className="text-6xl font-black italic tracking-tighter uppercase mb-4 leading-none">1v1 Combat Protocol</h1>
        ...
        {status === 'searching' && (
          ...
          >
             ...
             <div className="text-center">
                <p className="text-slate-400 font-black italic uppercase text-[11px] tracking-[0.2em] mb-3">Scanning Neural Channels</p>
                <h2 className="text-4xl font-black italic tracking-tighter uppercase mb-8 flex items-center gap-6 justify-center">
        ...
        {status === 'found' && (
          ...
          >
             <div className="flex items-center gap-16 mb-16 px-12 py-12 bg-white border border-slate-200 rounded-[64px] shadow-2xl shadow-indigo-500/10">
                ...
                <div className="flex flex-col items-center">
                   ...
                   <div className="px-5 py-2 bg-emerald-50 rounded-full">
                    <p className="text-[10px] font-black uppercase tracking-widest text-emerald-600 italic">SIGNAL LOCKED</p>
                   </div>
                </div>
             ...
             <h2 className="text-6xl font-black italic tracking-tighter uppercase text-center mb-8 leading-none">
        ...
        {status === 'error' && (
          ...
          >
             ...
             <h2 className="text-3xl font-black italic tracking-tighter uppercase mb-4 text-rose-600">Signal Corruption</h2>
