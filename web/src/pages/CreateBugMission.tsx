      ...
      <div className="max-w-5xl mx-auto">
        ...
        <header className="mb-12">
          <div className="flex items-center gap-4 mb-4">
             ...
             <div>
               <h1 className="text-5xl font-black italic tracking-tighter uppercase leading-none">Architect Bug Mission</h1>
        ...
        <form onSubmit={handleSave} className="space-y-12">
          ...
          <section className="bg-white border border-slate-200 rounded-[48px] p-12 shadow-xl shadow-slate-200/50">
             <div className="flex items-center gap-5 mb-12">
                ...
                <div>
                  <h2 className="text-2xl font-black italic tracking-tighter uppercase">Tactical Briefing</h2>
          ...
          <section className="bg-slate-900 border border-slate-800 rounded-[48px] p-12 shadow-2xl overflow-hidden relative group">
             ...
             <div className="flex items-center gap-5 mb-12 relative z-10">
                ...
                <div>
                  <h2 className="text-2xl font-black italic tracking-tighter uppercase text-white">Neural Corruption (Buggy Code)</h2>
          ...
          <section className="bg-white border border-slate-200 rounded-[48px] p-12 shadow-xl shadow-slate-200/50">
             <div className="flex items-center justify-between mb-12">
                <div className="flex items-center gap-5">
                   ...
                   <div>
                     <h2 className="text-2xl font-black italic tracking-tighter uppercase">Sanitization Vectors</h2>
                   ...
                   >
                      <div className="flex items-center justify-between mb-6">
                         <div className="flex items-center gap-4">
                            <span className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[10px] font-black text-slate-900 shadow-sm border border-slate-100 italic">{i+1}</span>
         ...
         {success && (
           ...
           >
              ...
              <div>
                 ...
                 <p className="text-[11px] font-black uppercase italic text-slate-900">Bug mission deployed successfully</p>
              </div>
              <motion.div 
                initial={{ width: '0%' }}
                animate={{ width: '100%' }}
