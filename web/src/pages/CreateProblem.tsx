    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 p-8 pt-25 pb-20">
      <div className="max-w-5xl mx-auto">
        ...
        <header className="mb-12">
          <h1 className="text-5xl font-black italic tracking-tighter uppercase mb-4 leading-none">Architect Challenge</h1>
        ...
        <form onSubmit={handleSave} className="space-y-12">
          ...
          <section className="bg-white border border-slate-200 rounded-[48px] p-12 shadow-xl shadow-slate-200/50">
             <div className="flex items-center gap-5 mb-12">
                ...
                <div>
                  <h2 className="text-2xl font-black italic tracking-tighter uppercase">Mission Parameters</h2>
          ...
          <section className="bg-white border border-slate-200 rounded-[48px] p-12 shadow-xl shadow-slate-200/50">
             <div className="flex items-center justify-between mb-12">
                <div className="flex items-center gap-5">
                   ...
                   <div>
                     <h2 className="text-2xl font-black italic tracking-tighter uppercase">Validation Vectors</h2>
          ...
          <section className="bg-white border border-slate-200 rounded-[48px] p-12 shadow-xl shadow-slate-200/50">
             <div className="flex items-center gap-5 mb-12">
                ...
                <div>
                  <h2 className="text-2xl font-black italic tracking-tighter uppercase">Neural Scaffolding</h2>
         ...
         {success && (
           ...
           >
              ...
              <div>
                 ...
                 <p className="text-[11px] font-black uppercase italic text-slate-900">Mission architected successfully</p>
              </div>
              <motion.div 
                initial={{ width: '0%' }}
                animate={{ width: '100%' }}
