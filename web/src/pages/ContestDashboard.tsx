      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
         {[
           ...
           >
              ...
              <h3 className="text-3xl font-black italic tracking-tighter uppercase">{stat.value}</h3>
           </motion.div>
         ))}
      </div>
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                         <span className={`px-2 py-0.5 rounded-full text-[8px] font-black uppercase tracking-widest ${
                            contest.status === 'Ongoing' ? 'bg-pink-500/10 text-pink-600' : 
                      ...
                      <h3 className="text-2xl font-black italic tracking-tighter uppercase group-hover:text-pink-600 transition-colors">{contest.title}</h3>
        ...
        <div className="space-y-8">
           <section>
              ...
              >
                 ...
                 <h3 className="text-xl font-black italic tracking-tighter uppercase mb-2 text-white">1v1 Code Duel</h3>
           ...
           <section>
              ...
              <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
                 <h3 className="text-xl font-black italic tracking-tighter uppercase mb-2">Team Contests</h3>
           ...
           {user?.user_access === 'admin' && (
             <section>
                ...
                >
                    ...
                    <h3 className="text-xl font-black italic tracking-tighter uppercase mb-2">Admin Command</h3>
