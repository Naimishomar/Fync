...
router.post('/create', authMiddleware, upload.fields([{ name: 'logo', maxCount: 1 }, { name: 'banner', maxCount: 1 }]), createSpeakerSession);
...
router.post('/add-speaker', authMiddleware, upload.single('image'), addSpeakerToSession);
router.put('/update-speaker', authMiddleware, upload.single('image'), updateSpeaker);
router.put('/update', authMiddleware, upload.fields([{ name: 'logo', maxCount: 1 }, { name: 'banner', maxCount: 1 }]), updateSpeakerSession);   
...
router.post("/community/send", authMiddleware, upload.single('image'), Interaction.sendEventMessage);
