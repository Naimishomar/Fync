...
router.post("/create", authMiddleware, isAdmin, upload.fields([{ name: 'logo', maxCount: 1 }, { name: 'banner', maxCount: 1 }]), r2UploadMiddleware({ logo: 'bootcamp_events', banner: 'bootcamp_events' }), BootcampController.createBootcamp);
