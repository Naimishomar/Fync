...
router.post("/create", authMiddleware, upload.fields([{ name: 'logo', maxCount: 1 }, { name: 'banner', maxCount: 1 }]), BootcampController.createBootcamp);
...
router.put("/update", authMiddleware, upload.fields([{ name: 'logo', maxCount: 1 }, { name: 'banner', maxCount: 1 }]), BootcampController.updateBootcamp);
